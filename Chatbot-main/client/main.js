...
// API key
const API_KEY ="AIzaSyBIkJYZzPOwbut1ufzYzFsFBn5TkeZG1i0"
...
// Adding check the daily question limit
const checkQuestionLimit = () => {
    ...
    return userQuestionCount < MAX_QUESTIONS_PER_DAY;
};

// to show limit exceed message
const showLimitExceededMessage = () => {
...
// adding warning when only 1 question left
...
//  with per day 10 question limit added here
